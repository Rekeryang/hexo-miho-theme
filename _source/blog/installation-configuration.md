...
欢迎Star和Fork；如遇到问题或发表建议，可以提[Issues](https://github.com/rekeryang/hexo-text-theme/issues)，也可以在博客中留言给我，另外,喜欢的话不妨给个 Star。
### 二. 安装
#### 2.1 安装主题
``` bash
...
```
###  四. 主题配置
编辑主题配置文件，`themes/text/_config.yml`。
#### 4.1 属性
下面将介绍几个比较重要的配置。
``` bash
# hexo-rky-theme
# https://github.com/rekeryang/hexo-rky-theme
...
keywords: rekryang  Blog
# Head headline | 头部标题
header_title: rekeryang Blog
